...
#################################################
test_set_size = len(open(args.input_path + "_train.csv").readlines())
...
print("##########################")
pred_probas = model.predict_generator(generate_batches_from_file(args.input_file, 128), steps=te_steps_per_ep + 1,
